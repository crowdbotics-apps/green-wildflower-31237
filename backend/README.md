...
## Project Structure
    ...
    ├── green_wildflower_31237  # Django project configurations
...
1. Clone this repo and `cd green_wildflower_31237`
...
2. Clone this repo and `cd green_wildflower_31237`
